...
import { ShieldCheck, Award, Eye, FileText, CheckCircle } from "lucide-react";
    ...
    <div className="w-full bg-white font-sans py-12 px-4 sm:px-8">
      <div className="max-w-[1000px] mx-auto">
        ...
        <header className="mb-10 text-center max-w-2xl mx-auto">
          <span className="text-[12px] uppercase tracking-widest font-extrabold text-primary-green">Operating Standards</span>
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16">
          <div className="flex flex-col gap-4">
            <h2 className="text-[24px] font-extrabold text-dark-slate">Why PestIQ was started</h2>
            <p className="text-zinc-650 text-[14.5px] leading-relaxed">
        ...
        {/* 3 Core Values Grid */}
        <section className="bg-zinc-50 border border-border-gray rounded-lg p-6 sm:p-8 mb-16">
          <h2 className="text-[20px] font-extrabold text-dark-slate mb-8 text-center uppercase tracking-wider">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center gap-3">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center border border-border-gray text-primary-green">
                <ShieldCheck className="w-6 h-6" />
              </div>
              <strong className="text-[16px] text-dark-slate font-bold">Property Safety First</strong>
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <strong className="text-[16px] text-dark-slate font-bold">Licensed Technicians</strong>
              <span className="text-[13px] text-zinc-500 leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center gap-3">
              ...
              <strong className="text-[16px] text-dark-slate font-bold">Detailed written sheets</strong>
              <span className="text-[13px] text-zinc-500 leading-relaxed">
        ...
        <section className="border border-border-gray rounded-lg p-6 sm:p-8">
          <h2 className="text-[20px] font-extrabold text-dark-slate mb-4">Credentials & Local Compliance</h2>
          <p className="text-zinc-650 text-[14px] leading-relaxed mb-5">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 bg-white border border-border-gray p-4 rounded flex items-start gap-3">
